const en = {
	...
	sharedMailNotExist: 'Shared recipient does not exist',
	sharedMailAdminOnly: 'Only mail received by the administrator can be shared',
	sharedMailPermRequired: 'Select the "View Shared Mailbox" permission before adding recipient addresses',
	sharedMailReadOnly: 'Shared mail is read-only and cannot be modified or deleted',
	perms: {
		"邮件": "Emails",
		"邮件发送": "Send Email",
		"邮件删除": "Delete Email",
		"共享邮箱": "View Shared Mail by Recipient",
		"邮箱侧栏": "Email Address",
		"邮箱查看": "View Email",
		"邮箱添加": "Add Email",
		"邮箱删除": "Delete Email",
